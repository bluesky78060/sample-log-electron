 ...
 */try{const r=Gu();if(r.firebase!==void 0){Wd.warn(`
    ...
    `);const e=r.firebase.SDK_VERSION;e&&e.indexOf("LITE")>=0&&Wd.warn(`
        ...
        `)}}catch{}const Se=TE;bE();var RE="firebase",PE="12.7.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Se.registerVersion(RE,PE,"app-compat");const Gi={FACEBOOK:"facebook.com",GITHUB:"github.com",GOOGLE:"google.com",PASSWORD:"password",TWITTER:"twitter.com"},Cr={EMAIL_SIGNIN:"EMAIL_SIGNIN",PASSWORD_RESET:"PASSWORD_RESET",RECOVER_EMAIL:"RECOVER_EMAIL",REVERT_SECOND_FACTOR_ADDITION:"REVERT_SECOND_FACTOR_ADDITION",VERIFY_AND_CHANGE_EMAIL:"VERIFY_AND_CHANGE_EMAIL",VERIFY_EMAIL:"VERIFY_EMAIL"};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wl{static credential(e,t){return cr.credential(e,t)}constructor(){this.providerId="phone",this._delegate=new cr(cg(Se.auth()))}verifyPhoneNumber(e,t){return this._delegate.verifyPhoneNumber(e,t)}unwrap(){return this._delegate}}wl.PHONE_SIGN_IN_METHOD=cr.PHONE_SIGN_IN_METHOD;wl.PROVIDER_ID=cr.PROVIDER_ID;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ab=O;class bb{constructor(e,t,n=Se.app()){var i;Ab((i=n.options)==null?void 0:i.apiKey,"invalid-api-key",{appName:n.name}),this._delegate=new xv(n.auth(),e,t),this.type=this._delegate.type}clear(){this._delegate.clear()}render(){return this._delegate.render()}verify(){return this._delegate.verify()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kn="remoteDocuments",so="owner",kr="owner",xs="mutationQueues",iR="userId",mt="mutations",Rf="batchId",er="userMutationsIndex",Pf=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eu extends Sg{constructor(e,t){super(),this.le=e,this.currentSequenceNumber=t}}function ke(r,e){const t=L(r);return Vt.O(t.le,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yP{bt(e){return ke(e,kl)}getSessionToken(e){return this.bt(e).get("sessionToken").next(t=>{const n=t==null?void 0:t.value;return n?ye.fromUint8Array(n):ye.EMPTY_BYTE_STRING})}setSessionToken(e,t){return this.bt(e).put({name:"sessionToken",value:t.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yt{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new C(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new C(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return W(this._lat,e._lat)||W(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:yt._jsonSchemaVersion}}static fromJSON(e){if(ro(e,yt._jsonSchema))return new yt(e.latitude,e.longitude)}}yt._jsonSchemaVersion="firestore/geoPoint/1.0",yt._jsonSchema={type:Re("string",yt._jsonSchemaVersion),latitude:Re("number"),longitude:Re("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function OC(r){r=Z(r,ae);const e=Z(r.firestore,ve);return Ry(je(e),r._key).then(t=>Ch(e,r,t))}It._jsonSchemaVersion="firestore/querySnapshot/1.0",It._jsonSchema={type:Re("string",It._jsonSchemaVersion),bundleSource:Re("string","QuerySnapshot"),bundleName:Re("string"),bundle:Re("string")};class Ar extends Sh{constructor(e){super(),this.firestore=e}convertBytes(e){return new $e(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ae(this.firestore,null,t)}}function xC(r){r=Z(r,ae);const e=Z(r.firestore,ve),t=je(e),n=new Ar(e);return nC(t,r._key).then(i=>new ht(e,n,r._key,i,new tr(i!==null&&i.hasLocalMutations,!0),r.converter))}function MC(r){r=Z(r,ae);const e=Z(r.firestore,ve);return Ry(je(e),r._key,{source:"server"}).then(t=>Ch(e,r,t))}function LC(r){r=Z(r,Ye);const e=Z(r.firestore,ve),t=je(e),n=new Ar(e);return jy(r._query),Py(t,r._query).then(i=>new It(e,n,r,i))}function FC(r){r=Z(r,Ye);const e=Z(r.firestore,ve),t=je(e),n=new Ar(e);return rC(t,r._query).then(i=>new It(e,n,r,i))}function UC(r){r=Z(r,Ye);const e=Z(r.firestore,ve),t=je(e),n=new Ar(e);return Py(t,r._query,{source:"server"}).then(i=>new It(e,n,r,i))}function Up(r,e,t){r=Z(r,ae);const n=Z(r.firestore,ve),i=dc(r.converter,e,t);return yo(n,[oc(Tr(n),"setDoc",r._key,i,r.converter!==null,t).toMutation(r._key,pe.none())])}function Bp(r,e,t,...n){r=Z(r,ae);const i=Z(r.firestore,ve),s=Tr(i);let o;return o=typeof(e=z(e))=="string"||e instanceof kn?Th(s,"updateDoc",r._key,e,t,n):Eh(s,"updateDoc",r._key,e),yo(i,[o.toMutation(r._key,pe.exists(!0))])}function BC(r){return yo(Z(r.firestore,ve),[new bi(r._key,pe.none())])}function qC(r,e){const t=Z(r.firestore,ve),n=Pa(r),i=dc(r.converter,e);return yo(t,[oc(Tr(r.firestore),"addDoc",n._key,i,r.converter!==null,{}).toMutation(n._key,pe.exists(!1))]).then(()=>n)}function Jy(r,...e){var u,l,f;r=z(r);let t={includeMetadataChanges:!1,source:"default"},n=0;typeof e[n]!="object"||qu(e[n])||(t=e[n++]);const i={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(qu(e[n])){const p=e[n];e[n]=(u=p.next)==null?void 0:u.bind(p),e[n+1]=(l=p.error)==null?void 0:l.bind(p),e[n+2]=(f=p.complete)==null?void 0:f.bind(p)}let s,o,c;if(r instanceof ae)o=Z(r.firestore,ve),c=vi(r._key.path),s={next:p=>{e[n]&&e[n](Ch(o,r,p))},error:e[n+1],complete:e[n+2]};else{const p=Z(r,Ye);o=Z(p.firestore,ve),c=p._query;const g=new Ar(o);s={next:v=>{e[n]&&e[n](new It(o,g,p,v))},error:e[n+1],complete:e[n+2]},jy(r._query)}return function(g,v,k,D){const V=new rc(D),q=new ch(v,V,k);return g.asyncQueue.enqueueAndForget(async()=>sh(await mi(g),q)),()=>{V.Nu(),g.asyncQueue.enqueueAndForget(async()=>oh(await mi(g),q))}}(je(o),c,i,s)}function $C(r,e){return iC(je(r=Z(r,ve)),qu(e)?e:{next:e})}function yo(r,e){return function(n,i){const s=new Le;return n.asyncQueue.enqueueAndForget(async()=>DS(await gh(n),i,s)),s.promise}(je(r),e)}function Ch(r,e,t){const n=t.docs.get(e._key),i=new Ar(r);return new ht(r,i,e._key,n,new tr(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
