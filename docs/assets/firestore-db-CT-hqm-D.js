 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xC(r){r=Z(r,ae);const e=Z(r.firestore,ve);return Ry(je(e),r._key).then(t=>Ch(e,r,t))}It._jsonSchemaVersion="firestore/querySnapshot/1.0",It._jsonSchema={type:Re("string",It._jsonSchemaVersion),bundleSource:Re("string","QuerySnapshot"),bundleName:Re("string"),bundle:Re("string")};class Ar extends Ph{constructor(e){super(),this.firestore=e}convertBytes(e){return new $e(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ae(this.firestore,null,t)}}function MC(r){r=Z(r,ae);const e=Z(r.firestore,ve),t=je(e),n=new Ar(e);return rC(t,r._key).then(i=>new ht(e,n,r._key,i,new tr(i!==null&&i.hasLocalMutations,!0),r.converter))}function LC(r){r=Z(r,ae);const e=Z(r.firestore,ve);return Ry(je(e),r._key,{source:"server"}).then(t=>Ch(e,r,t))}function FC(r){r=Z(r,Ye);const e=Z(r.firestore,ve),t=je(e),n=new Ar(e);return jy(r._query),Sy(t,r._query).then(i=>new It(e,n,r,i))}function UC(r){r=Z(r,Ye);const e=Z(r.firestore,ve),t=je(e),n=new Ar(e);return iC(t,r._query).then(i=>new It(e,n,r,i))}function BC(r){r=Z(r,Ye);const e=Z(r.firestore,ve),t=je(e),n=new Ar(e);return Sy(t,r._query,{source:"server"}).then(i=>new It(e,n,r,i))}function Up(r,e,t){r=Z(r,ae);const n=Z(r.firestore,ve),i=dc(r.converter,e,t);return yo(n,[oc(Tr(n),"setDoc",r._key,i,r.converter!==null,t).toMutation(r._key,pe.none())])}function Bp(r,e,t,...n){r=Z(r,ae);const i=Z(r.firestore,ve),s=Tr(i);let o;return o=typeof(e=j(e))=="string"||e instanceof kn?Th(s,"updateDoc",r._key,e,t,n):Eh(s,"updateDoc",r._key,e),yo(i,[o.toMutation(r._key,pe.exists(!0))])}function qC(r){return yo(Z(r.firestore,ve),[new bi(r._key,pe.none())])}function $C(r,e){const t=Z(r.firestore,ve),n=Sa(r),i=dc(r.converter,e);return yo(t,[oc(Tr(r.firestore),"addDoc",n._key,i,r.converter!==null,{}).toMutation(n._key,pe.exists(!1))]).then(()=>n)}function Jy(r,...e){var u,l,f;r=j(r);let t={includeMetadataChanges:!1,source:"default"},n=0;typeof e[n]!="object"||qu(e[n])||(t=e[n++]);const i={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(qu(e[n])){const p=e[n];e[n]=(u=p.next)==null?void 0:u.bind(p),e[n+1]=(l=p.error)==null?void 0:l.bind(p),e[n+2]=(f=p.complete)==null?void 0:f.bind(p)}let s,o,c;if(r instanceof ae)o=Z(r.firestore,ve),c=vi(r._key.path),s={next:p=>{e[n]&&e[n](Ch(o,r,p))},error:e[n+1],complete:e[n+2]};else{const p=Z(r,Ye);o=Z(p.firestore,ve),c=p._query;const g=new Ar(o);s={next:v=>{e[n]&&e[n](new It(o,g,p,v))},error:e[n+1],complete:e[n+2]},jy(r._query)}return function(g,v,k,N){const D=new rc(N),$=new ch(v,D,k);return g.asyncQueue.enqueueAndForget(async()=>sh(await mi(g),$)),()=>{D.Nu(),g.asyncQueue.enqueueAndForget(async()=>oh(await mi(g),$))}}(je(o),c,i,s)}function zC(r,e){return sC(je(r=Z(r,ve)),qu(e)?e:{next:e})}function yo(r,e){return function(n,i){const s=new Le;return n.asyncQueue.enqueueAndForget(async()=>VP(await gh(n),i,s)),s.promise}(je(r),e)}function Ch(r,e,t){const n=t.docs.get(e._key),i=new Ar(r);return new ht(r,i,e._key,n,new tr(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ck(r){ak(r,(e,t)=>new Yy(e,t,new rk)),r.registerVersion(ek,tk)}ck(Pe);var uk={};const lk=(()=>{var r;if(typeof process<"u"&&uk)return(r=process.argv)==null?void 0:r.includes("--dev");try{return localStorage.getItem("DEBUG_MODE")==="true"}catch{return!1}})(),dt=(...r)=>lk&&console.log("[Firestore]",...r),hk={soil:"soilSamples",water:"waterSamples",compost:"compostSamples",heavyMetal:"heavyMetalSamples","heavy-metal":"heavyMetalSamples",pesticide:"pesticideSamples",waterTestResults:"waterTestResults",pesticideTestResults:"pesticideTestResults",compostTestResults:"compostTestResults",heavyMetalTestResults:"heavyMetalTestResults"};function br(r,e){return`${hk[r]||r}_${e}`}function nI(r){return r==null?"":String(r)}function dk(r){return Array.isArray(r)?r.map(e=>({...e,id:nI(e.id)})):r}async function fk(r,e,t,n){var i,s;if(!((i=window.firebaseConfig)!=null&&i.isEnabled()))return!1;try{const o=window.firebaseConfig.getDb();if(!o)return!1;const c=br(r,e);return await o.collection(c).doc(t).set({...n,updatedAt:Pe.firestore.FieldValue.serverTimestamp(),syncedAt:Pe.firestore.FieldValue.serverTimestamp()},{merge:!0}),dt(`저장 완료: ${c}/${t}`),!0}catch(o){return(((s=window.logger)==null?void 0:s.error)||console.error)("Firestore 저장 실패:",o),!1}}async function pk(r,e,t){var n,i;if(!((n=window.firebaseConfig)!=null&&n.isEnabled()))return null;try{const s=window.firebaseConfig.getDb();if(!s)return null;const o=br(r,e),c=await s.collection(o).doc(t).get();return c.exists?{id:c.id,...c.data()}:null}catch(s){return(((i=window.logger)==null?void 0:i.error)||console.error)("Firestore 조회 실패:",s),null}}async function rI(r,e,t={}){var n,i,s;if(!((n=window.firebaseConfig)!=null&&n.isEnabled()))return{documents:[],fromCache:!1};try{const o=window.firebaseConfig.getDb();if(!o)return{documents:[],fromCache:!1};const c=br(r,e),l=await o.collection(c).get(),f=((i=l.metadata)==null?void 0:i.fromCache)===!0,p=[];return l.forEach(g=>{p.push({id:g.id,...g.data()})}),p.length>0&&p.sort((g,v)=>{var D,$,z,q;const k=((D=g.createdAt)==null?void 0:D.seconds)||(($=g.updatedAt)==null?void 0:$.seconds)||0,N=((z=v.createdAt)==null?void 0:z.seconds)||((q=v.updatedAt)==null?void 0:q.seconds)||0;return k-N}),dt(`조회 완료: ${c} (${p.length}건, fromCache=${f})`),{documents:dk(p),fromCache:f}}catch(o){return(((s=window.logger)==null?void 0:s.error)||console.error)("Firestore 전체 조회 실패:",o),{documents:[],fromCache:!1}}}async function mk(r,e,t={}){const{documents:n}=await rI(r,e,t);return n}async function gk(r,e,t){var n;if(!((n=window.firebaseConfig)!=null&&n.isEnabled()))return!1;try{const i=window.firebaseConfig.getDb();if(!i)return!1;const s=br(r,e),o=String(typeof t=="number"?t:t||""),c=parseInt(o,10);if(!o)return!1;const u=i.collection(s).doc(o);if((await u.get()).exists)return await u.delete(),dt(`삭제 완료: ${s}/${o}`),!0;let f=await i.collection(s).where("id","==",o).get();if(f.empty&&!isNaN(c)&&(f=await i.collection(s).where("id","==",c).get()),f.empty)return dt(`삭제 대상 없음(멱등 성공): ${s}/${o}`),!0;const p=[];return f.forEach(g=>{p.push(g.ref.delete())}),await Promise.all(p),dt(`삭제 완료 (쿼리): ${s}/${o} (${f.size}건)`),!0}catch(i){return console.error("Firestore 삭제 실패:",i),!1}}async function iI(r,e,t){var n,i;if(!((n=window.firebaseConfig)!=null&&n.isEnabled())||!t.length)return!1;try{const s=window.firebaseConfig.getDb();if(!s)return!1;const o=br(r,e),c=450,u=[];for(let l=0;l<t.length;l+=c)u.push(t.slice(l,l+c));dt(`배치 저장 시작: ${o} (${t.length}건, ${u.length}개 청크)`);for(let l=0;l<u.length;l++){const f=u[l],p=s.batch();f.forEach(g=>{let v=nI(g.id).trim();v||(v=sI());const k=s.collection(o).doc(v),N={...g,id:v,updatedAt:Pe.firestore.FieldValue.serverTimestamp(),syncedAt:Pe.firestore.FieldValue.serverTimestamp()};g.createdAt||(N.createdAt=Pe.firestore.FieldValue.serverTimestamp()),p.set(k,N,{merge:!0})}),await p.commit(),dt(`청크 ${l+1}/${u.length} 완료 (${f.length}건)`)}return dt(`배치 저장 완료: ${o} (${t.length}건)`),!0}catch(s){return(((i=window.logger)==null?void 0:i.error)||console.error)("Firestore 배치 저장 실패:",s),!1}}async function _k(r,e,t){var n,i,s;if(!((n=window.firebaseConfig)!=null&&n.isEnabled()))return{success:!1,count:0};try{const o=localStorage.getItem(t);if(!o)return dt("마이그레이션할 데이터가 없습니다."),{success:!0,count:0};let c;try{c=JSON.parse(o)}catch(l){return(((i=window.logger)==null?void 0:i.error)||console.error)(`마이그레이션 JSON 파싱 실패 (${t}):`,l),{success:!1,count:0,message:"JSON 파싱 실패"}}if(!Array.isArray(c)||c.length===0)return{success:!0,count:0};const u=c.map(l=>({...l,id:l.id||yk()}));return await iI(r,e,u),dt(`마이그레이션 완료: ${t} → Firestore (${u.length}건)`),{success:!0,count:u.length}}catch(o){return(((s=window.logger)==null?void 0:s.error)||console.error)("마이그레이션 실패:",o),{success:!1,count:0}}}function sI(){return typeof crypto<"u"&&crypto.randomUUID?crypto.randomUUID():Date.now().toString(36)+Array.from(crypto.getRandomValues(new Uint8Array(6)),r=>r.toString(36)).join("").substring(0,9)}function yk(){return sI()}function Ik(r,e,t){var n,i;if(!((n=window.firebaseConfig)!=null&&n.isEnabled()))return null;try{const s=window.firebaseConfig.getDb();if(!s)return null;const o=br(r,e),c=s.collection(o).onSnapshot(u=>{const l=[];u.forEach(f=>{l.push({id:f.id,...f.data()})}),t(l,u.metadata.fromCache)},u=>{var l;(((l=window.logger)==null?void 0:l.error)||console.error)("실시간 동기화 에러:",u)});return dt(`실시간 동기화 시작: ${o}`),c}catch(s){return(((i=window.logger)==null?void 0:i.error)||console.error)("실시간 동기화 설정 실패:",s),null}}function wk(){var r;return((r=window.firebaseConfig)==null?void 0:r.isEnabled())===!0}function Ek(){var r;return((r=window.firebaseConfig)==null?void 0:r.isOfflineSupported())===!0}window.firestoreDb={init:async function(){return dt("firestoreDb.init() 호출됨 (no-op)"),!0},save:fk,get:pk,getAll:mk,getAllWithMeta:rI,delete:gk,batchSave:iI,migrate:_k,subscribe:Ik,isEnabled:wk,isOfflineEnabled:Ek,getCollectionName:br};
