 ...
 */try{const r=Qu();if(r.firebase!==void 0){Qd.warn(`
    ...
    `);const e=r.firebase.SDK_VERSION;e&&e.indexOf("LITE")>=0&&Qd.warn(`
        ...
        `)}}catch{}const Ve=kE;VE();var OE="firebase",xE="12.7.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vl{static credential(e,t){return hr.credential(e,t)}constructor(){this.providerId="phone",this._delegate=new hr(pg(Ve.auth()))}verifyPhoneNumber(e,t){return this._delegate.verifyPhoneNumber(e,t)}unwrap(){return this._delegate}}vl.PHONE_SIGN_IN_METHOD=hr.PHONE_SIGN_IN_METHOD;vl.PROVIDER_ID=hr.PROVIDER_ID;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nb=O;class Vb{constructor(e,t,n=Ve.app()){var i;Nb((i=n.options)==null?void 0:i.apiKey,"invalid-api-key",{appName:n.name}),this._delegate=new zv(n.auth(),e,t),this.type=this._delegate.type}clear(){this._delegate.clear()}render(){return this._delegate.render()}verify(){return this._delegate.verify()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $C(r){r=Z(r,ae);const e=Z(r.firestore,ve);return Ny(je(e),r._key).then(t=>Nh(e,r,t))}wt._jsonSchemaVersion="firestore/querySnapshot/1.0",wt._jsonSchema={type:Re("string",wt._jsonSchemaVersion),bundleSource:Re("string","QuerySnapshot"),bundleName:Re("string"),bundle:Re("string")};class Sr extends Dh{constructor(e){super(),this.firestore=e}convertBytes(e){return new $e(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ae(this.firestore,null,t)}}function zC(r){r=Z(r,ae);const e=Z(r.firestore,ve),t=je(e),n=new Sr(e);return lC(t,r._key).then(i=>new dt(e,n,r._key,i,new ir(i!==null&&i.hasLocalMutations,!0),r.converter))}function jC(r){r=Z(r,ae);const e=Z(r.firestore,ve);return Ny(je(e),r._key,{source:"server"}).then(t=>Nh(e,r,t))}function GC(r){r=Z(r,Ye);const e=Z(r.firestore,ve),t=je(e),n=new Sr(e);return Jy(r._query),Vy(t,r._query).then(i=>new wt(e,n,r,i))}function WC(r){r=Z(r,Ye);const e=Z(r.firestore,ve),t=je(e),n=new Sr(e);return hC(t,r._query).then(i=>new wt(e,n,r,i))}function KC(r){r=Z(r,Ye);const e=Z(r.firestore,ve),t=je(e),n=new Sr(e);return Vy(t,r._query,{source:"server"}).then(i=>new wt(e,n,r,i))}function zp(r,e,t){r=Z(r,ae);const n=Z(r.firestore,ve),i=mc(r.converter,e,t);return Eo(n,[uc(br(n),"setDoc",r._key,i,r.converter!==null,t).toMutation(r._key,pe.none())])}function jp(r,e,t,...n){r=Z(r,ae);const i=Z(r.firestore,ve),s=br(i);let o;return o=typeof(e=z(e))=="string"||e instanceof Vn?bh(s,"updateDoc",r._key,e,t,n):Ah(s,"updateDoc",r._key,e),Eo(i,[o.toMutation(r._key,pe.exists(!0))])}function HC(r){return Eo(Z(r.firestore,ve),[new Pi(r._key,pe.none())])}function QC(r,e){const t=Z(r.firestore,ve),n=ka(r),i=mc(r.converter,e);return Eo(t,[uc(br(r.firestore),"addDoc",n._key,i,r.converter!==null,{}).toMutation(n._key,pe.exists(!1))]).then(()=>n)}function nI(r,...e){var u,l,f;r=z(r);let t={includeMetadataChanges:!1,source:"default"},n=0;typeof e[n]!="object"||ju(e[n])||(t=e[n++]);const i={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(ju(e[n])){const p=e[n];e[n]=(u=p.next)==null?void 0:u.bind(p),e[n+1]=(l=p.error)==null?void 0:l.bind(p),e[n+2]=(f=p.complete)==null?void 0:f.bind(p)}let s,o,c;if(r instanceof ae)o=Z(r.firestore,ve),c=Ri(r._key.path),s={next:p=>{e[n]&&e[n](Nh(o,r,p))},error:e[n+1],complete:e[n+2]};else{const p=Z(r,Ye);o=Z(p.firestore,ve),c=p._query;const g=new Sr(o);s={next:v=>{e[n]&&e[n](new wt(o,g,p,v))},error:e[n+1],complete:e[n+2]},Jy(r._query)}return function(g,v,k,D){const N=new oc(D),q=new hh(v,N,k);return g.asyncQueue.enqueueAndForget(async()=>ch(await yi(g),q)),()=>{N.Nu(),g.asyncQueue.enqueueAndForget(async()=>uh(await yi(g),q))}}(je(o),c,i,s)}function JC(r,e){return dC(je(r=Z(r,ve)),ju(e)?e:{next:e})}function Eo(r,e){return function(n,i){const s=new Le;return n.asyncQueue.enqueueAndForget(async()=>UP(await Ih(n),i,s)),s.promise}(je(r),e)}function Nh(r,e,t){const n=t.docs.get(e._key),i=new Sr(r);return new dt(r,i,e._key,n,new ir(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
